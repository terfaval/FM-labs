...
### Eyebrow
Csendes technológia belsõ tapasztalatokhoz
...
describe("parseLumiraModal", () => {
  it("parses hero eyebrow, kiindulo title/body, a flow block, and grids", () => {
    ...
    expect(content.hero.eyebrow).toBe("Csendes technológia belsõ tapasztalatokhoz");
